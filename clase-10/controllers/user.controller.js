...
userController.getUser = async function(req, res, next) {
    try {
        ...
        return  res.status(200).json({ status:200, data:user, message: "Successufully users retrived"});
    }catch(e) {
        return  res.status(400).json({ status:400, message: error.message})
    }
}
...
userController.updateUser = async function(req, res, next) {
    try {
        ...
        return  res.status(200).json({ status:200, data:updateUser, message: "Successufully update user"});
    }catch(error) {
        return  res.status(400).json({ status:400, message: error.message});
    }
}
